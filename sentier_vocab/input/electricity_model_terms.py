...
ELECTRICITY_MODEL_TERMS_DATA = [
    ...
    (CS, "definition", "The production emission factor is the ratio of emissions produced to the amount of electricity generated.", "en"),
    ...
    ("bonsai-prod-ef", "definition", "The Bonsai production emission factor is the ratio of emissions produced to the amount of electricity generated based on data from Bonsai.", "en"),
