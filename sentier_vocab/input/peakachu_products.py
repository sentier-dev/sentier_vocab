...
ELECTRICITY_PRODUCTS_DATA = [ 
    ...
    ("other", "type", "Concept"),
    ("other", "broader", PRODUCTS + "other-renewable"),
    ("other", "prefLabel", "Electrical energy from other renewable sources", "en"),
    ("other", "definition", "Electrical energy from other renewable sources includes electricity generated from various innovative renewable technologies.", "en"),
    ...
    ("nuclear", "broader", PRODUCTS + "other"),
    ("nuclear", "prefLabel", "Other electrical energy", "en"),
    ...
    ("waste", "type", "Concept"),
    ("waste", "broader", PRODUCTS + "other"),
    ("waste", "prefLabel", "Waste-based electrical energy", "en"),
    ...
    ("other", "type", "Concept"),
    ("other", "broader", PRODUCTS + "other"),
    ("other", "prefLabel", "Other electrical energy sources", "en"),
    ("other", "definition", "Other electrical energy sources encompass diverse methods and technologies for generating electricity that do not fall into traditional categories.", "en"),
    # Electricity mix
