...
class Product(Concept):
    ...
    cpc_code: Optional[str] = Field(default=None, description="""Central Product Classification code.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Product'], 'slot_uri': 'ont:cpcCode'} })
    reference_flow_property: Optional[str] = Field(default=None, description="""The reference flow property for this product.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Product'], 'slot_uri': 'ont:referenceFlowProperty'} })
    iri: str = Field(default=..., description="""Globally unique IRI identifying this concept.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['Concept'],
         'slot_uri': 'skos:prefLabel'} })
...
class ProductCollection(ConfiguredBaseModel):
    ...
    scheme: str = Field(default=..., description="""The ConceptScheme IRI these products belong to.""", json_schema_extra = { "linkml_meta": {'annotations': {'internal': {'tag': 'internal', 'value': True}},
         'domain_of': ['ProductCollection']} })
    products: Optional[list[Product]] = Field(default=None, description="""The products in this collection.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ProductCollection']} })
