...
class ImpactCategory(Concept):
    ...
    indicator: Optional[str] = Field(default=None, description="""The characterisation indicator for this impact category.""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['ImpactCategory'],
         'slot_uri': 'ont:indicator'} })
    reference_unit: Optional[str] = Field(default=None, description="""The reference unit for this impact category.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ImpactCategory'], 'slot_uri': 'qudt:hasUnit'} })
    time_horizon: Optional[str] = Field(default=None, description="""The time horizon for this impact category.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ImpactCategory'], 'slot_uri': 'ont:timeHorizon'} })
    method: Optional[str] = Field(default=None, description="""The LCIA method this category belongs to.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ImpactCategory'], 'slot_uri': 'ont:method'} })
    normalization_factor: Optional[float] = Field(default=None, description="""Normalisation factor for this impact category.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ImpactCategory'], 'slot_uri': 'ont:normalizationFactor'} })
    weighting_factor: Optional[float] = Field(default=None, description="""Weighting factor for this impact category.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ImpactCategory'], 'slot_uri': 'ont:weightingFactor'} })
    iri: str = Field(default=..., description="""Globally unique IRI identifying this concept.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['Concept'],
         'slot_uri': 'skos:prefLabel'} })
...
class ImpactCategoryCollection(ConfiguredBaseModel):
    ...
    scheme: str = Field(default=..., description="""The ConceptScheme IRI these impact categories belong to.""", json_schema_extra = { "linkml_meta": {'annotations': {'internal': {'tag': 'internal', 'value': True}},
         'domain_of': ['ImpactCategoryCollection']} })
    impact_categories: Optional[list[ImpactCategory]] = Field(default=None, description="""The impact categories in this collection.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ImpactCategoryCollection']} })
