...
linkml_meta = LinkMLMeta({'default_prefix': 'sentier',
     ...
     'description': 'Schema for native LCIA-method terms.',
     'id': 'https://vocab.sentier.dev/schemas/lcia-method',
     'imports': ['linkml:types', 'common'],
     'license': 'MIT',
     'name': 'sentier_lcia_method',
     ...
     'source_file': 'schemas/lcia-method.yaml',
     'title': 'Sentier.dev LCIA methods'} )
...
class LCIAMethod(Concept):
    """
    A life cycle impact assessment method providing characterization factors for one or more impact categories.

    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'skos:Concept',
         'from_schema': 'https://vocab.sentier.dev/schemas/lcia-method'})

    methodology: Optional[str] = Field(default=None, description="""The overarching methodology or framework of this LCIA method.""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['LCIAMethod'],
         'slot_uri': 'ont:methodology'} })
    impact_categories: Optional[list[str]] = Field(default=None, description="""Impact categories covered by this LCIA method.""", json_schema_extra = { "linkml_meta": {'domain_of': ['LCIAMethod'], 'slot_uri': 'ont:impactCategory'} })
    source: Optional[str] = Field(default=None, description="""Source reference for this LCIA method.""", json_schema_extra = { "linkml_meta": {'domain_of': ['LCIAMethod'], 'slot_uri': 'dcterms:source'} })
    valid_from: Optional[date] = Field(default=None, description="""Date from which this LCIA method is valid.""", json_schema_extra = { "linkml_meta": {'domain_of': ['LCIAMethod'], 'slot_uri': 'ont:validFrom'} })
    iri: str = Field(default=..., description="""Globally unique IRI identifying this concept.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['Concept'],
         'slot_uri': 'skos:prefLabel'} })
...
class LCIAMethodCollection(ConfiguredBaseModel):
    """
    A scheme/group file holding many LCIA methods.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'layer': {'tag': 'layer', 'value': 'vocabulary'}},
         'from_schema': 'https://vocab.sentier.dev/schemas/lcia-method',
         'tree_root': True})

    scheme: str = Field(default=..., description="""The ConceptScheme IRI these LCIA methods belong to.""", json_schema_extra = { "linkml_meta": {'annotations': {'internal': {'tag': 'internal', 'value': True}},
         'domain_of': ['LCIAMethodCollection']} })
    lcia_methods: Optional[list[LCIAMethod]] = Field(default=None, description="""The LCIA methods in this collection.""", json_schema_extra = { "linkml_meta": {'domain_of': ['LCIAMethodCollection']} })


# Model rebuild
# see https://pydantic-docs.helpmanual.io/usage/models/#rebuilding-a-model
Concept.model_rebuild()
LCIAMethod.model_rebuild()
LCIAMethodCollection.model_rebuild()
