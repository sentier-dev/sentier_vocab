...
class Concept(ConfiguredBaseModel):
    ...
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept'], 'slot_uri': 'skos:prefLabel'} })
    alt_labels: Optional[list[str]] = Field(default=None, description="""Alternative labels / synonyms.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept'], 'slot_uri': 'skos:altLabel'} })
    definition: Optional[str] = Field(default=None, description="""SKOS definition.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept'], 'slot_uri': 'skos:definition'} })
    ...
    status: Optional[StatusEnum] = Field(default=None, description="""Curation status of this term.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
...
class ElementaryFlow(Concept):
    ...
    compartment: Optional[str] = Field(default=None, description="""Environmental compartment (e.g. air, water, soil).""", json_schema_extra = { "linkml_meta": {'domain_of': ['ElementaryFlow']} })
    sub_compartment: Optional[str] = Field(default=None, description="""Sub-compartment refinement (e.g. \"low population density\").""", json_schema_extra = { "linkml_meta": {'domain_of': ['ElementaryFlow']} })
    cas_number: Optional[str] = Field(default=None, description="""CAS registry number, if applicable.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ElementaryFlow']} })
    formula: Optional[str] = Field(default=None, description="""Chemical formula, if applicable.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ElementaryFlow']} })
    iri: str = Field(default=..., description="""Globally unique IRI identifying this concept.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept'], 'slot_uri': 'skos:prefLabel'} })
    alt_labels: Optional[list[str]] = Field(default=None, description="""Alternative labels / synonyms.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept'], 'slot_uri': 'skos:altLabel'} })
    definition: Optional[str] = Field(default=None, description="""SKOS definition.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept'], 'slot_uri': 'skos:definition'} })
...
class ElementaryFlowCollection(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://vocab.sentier.dev/schemas/elementary-flow',
         'tree_root': True})

    scheme: str = Field(default=..., description="""The ConceptScheme IRI these flows belong to.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ElementaryFlowCollection']} })
    flows: Optional[list[ElementaryFlow]] = Field(default=None, description="""The elementary flows in this group.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ElementaryFlowCollection']} })
