...
class UnitGroup(Concept):
    ...
    reference_unit: Optional[str] = Field(
        default=None,
        description="""The reference (base) unit for this unit group.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["UnitGroup"], "slot_uri": "qudt:hasUnit"}
        },
    )
    units: Optional[list[str]] = Field(
        default=None,
        description="""All units belonging to this unit group.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["UnitGroup"], "slot_uri": "ont:hasUnit"}},
    )
    quantity_kind: Optional[str] = Field(
        default=None,
        description="""The quantity kind this unit group measures.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["UnitGroup"], "slot_uri": "qudt:hasQuantityKind"}
        },
    )
    iri: str = Field(
        default=...,
...
class UnitGroupCollection(ConfiguredBaseModel):
    ...
    scheme: str = Field(
        default=...,
        description="""The ConceptScheme IRI these unit groups belong to.""",
        json_schema_extra={
            "linkml_meta": {
                "annotations": {"internal": {"tag": "internal", "value": True}},
    ...
    unit_groups: Optional[list[UnitGroup]] = Field(
        default=None,
        description="""The unit groups in this collection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["UnitGroupCollection"]}},
    )
