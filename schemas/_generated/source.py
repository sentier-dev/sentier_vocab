...
class Source(Concept):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "skos:Concept", "from_schema": "https://vocab.sentier.dev/schemas/source"}
    )
    ...
    creators: Optional[list[str]] = Field(
        default=None,
        description="""The creators or authors of the source.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Source"], "slot_uri": "dcterms:creator"}
        },
    )
    date: Optional[date] = Field(
        default=None,
        description="""The date of publication.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Source"], "slot_uri": "dcterms:date"}},
    )
    publisher: Optional[str] = Field(
        default=None,
        description="""The publisher of the source.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Source"], "slot_uri": "dcterms:publisher"}
        },
    )
    identifier: Optional[str] = Field(
        default=None,
        description="""A formal identifier (e.g. DOI) for the source.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Source"], "slot_uri": "dcterms:identifier"}
        },
    )
    citation: Optional[str] = Field(
        default=None,
        description="""A human-readable citation string.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Source"], "slot_uri": "ont:citation"}},
    )
    iri: str = Field(
        default=...,
        description="""Globally unique IRI identifying this concept.""",
...
class SourceCollection(ConfiguredBaseModel):
    ...
    scheme: str = Field(
        default=...,
        description="""The ConceptScheme IRI these sources belong to.""",
        json_schema_extra={
            "linkml_meta": {
                "annotations": {"internal": {"tag": "internal", "value": True}},
    ...
    sources: Optional[list[Source]] = Field(
        default=None,
        description="""The sources in this collection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SourceCollection"]}},
    )
