...
linkml_meta = LinkMLMeta({'default_prefix': 'sentier',
     ...
     'description': 'Schema for native source (bibliographic reference) terms.',
     'id': 'https://vocab.sentier.dev/schemas/source',
...
class Source(Concept):
    """
    A bibliographic source or reference used to support vocabulary terms.

    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'skos:Concept',
         'from_schema': 'https://vocab.sentier.dev/schemas/source'})

    title: Optional[str] = Field(default=None, description="""The title of the source.""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['Source'],
         'slot_uri': 'dcterms:title'} })
    creators: Optional[list[str]] = Field(default=None, description="""The creators or authors of the source.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Source'], 'slot_uri': 'dcterms:creator'} })
    date: Optional[date] = Field(default=None, description="""The date of publication.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Source'], 'slot_uri': 'dcterms:date'} })
    publisher: Optional[str] = Field(default=None, description="""The publisher of the source.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Source'], 'slot_uri': 'dcterms:publisher'} })
    identifier: Optional[str] = Field(default=None, description="""A formal identifier (e.g. DOI) for the source.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Source'], 'slot_uri': 'dcterms:identifier'} })
    citation: Optional[str] = Field(default=None, description="""A human-readable citation string.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Source'], 'slot_uri': 'ont:citation'} })
    iri: str = Field(default=..., description="""Globally unique IRI identifying this concept.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['Concept'],
         'slot_uri': 'skos:prefLabel'} })
...
class SourceCollection(ConfiguredBaseModel):
    """
    A scheme/group file holding many sources.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'layer': {'tag': 'layer', 'value': 'vocabulary'}},
         'from_schema': 'https://vocab.sentier.dev/schemas/source',
         'tree_root': True})

    scheme: str = Field(default=..., description="""The ConceptScheme IRI these sources belong to.""", json_schema_extra = { "linkml_meta": {'annotations': {'internal': {'tag': 'internal', 'value': True}},
         'domain_of': ['SourceCollection']} })
    sources: Optional[list[Source]] = Field(default=None, description="""The sources in this collection.""", json_schema_extra = { "linkml_meta": {'domain_of': ['SourceCollection']} })
...
SourceCollection.model_rebuild()
