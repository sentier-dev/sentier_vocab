...
class FlowProperty(Concept):
    ...
    default_unit_group: Optional[str] = Field(
        default=None,
        description="""The default unit group for this flow property.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["FlowProperty"], "slot_uri": "ont:defaultUnitGroup"}
        },
    )
    default_unit: Optional[str] = Field(
        default=None,
        description="""The default unit for this flow property.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["FlowProperty"], "slot_uri": "qudt:hasUnit"}
        },
    )
    data_type: Optional[DataTypeEnum] = Field(
        default=None,
        description="""The data type category of this flow property.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["FlowProperty"], "slot_uri": "ont:dataType"}
        },
    )
    iri: str = Field(
        default=...,
...
class FlowPropertyCollection(ConfiguredBaseModel):
    ...
    scheme: str = Field(
        default=...,
        description="""The ConceptScheme IRI these flow properties belong to.""",
        json_schema_extra={
            "linkml_meta": {
                "annotations": {"internal": {"tag": "internal", "value": True}},
    ...
    flow_properties: Optional[list[FlowProperty]] = Field(
        default=None,
        description="""The flow properties in this collection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["FlowPropertyCollection"]}},
    )
