...
linkml_meta = LinkMLMeta({'default_prefix': 'sentier',
     ...
     'description': 'Schema for native flow-property terms.',
     'id': 'https://vocab.sentier.dev/schemas/flow-property',
     'imports': ['linkml:types', 'common'],
     'license': 'MIT',
     'name': 'sentier_flow_property',
     ...
     'source_file': 'flow-property.yaml',
     'title': 'Sentier.dev flow properties'} )
...
class FlowProperty(Concept):
    """
    A quantitative property used to express the magnitude of an elementary or product flow (e.g. mass, volume, energy).

    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'skos:Concept',
         'from_schema': 'https://vocab.sentier.dev/schemas/flow-property'})

    default_unit_group: Optional[str] = Field(default=None, description="""The default unit group for this flow property.""", json_schema_extra = { "linkml_meta": {'domain_of': ['FlowProperty'], 'slot_uri': 'ont:defaultUnitGroup'} })
    default_unit: Optional[str] = Field(default=None, description="""The default unit for this flow property.""", json_schema_extra = { "linkml_meta": {'domain_of': ['FlowProperty'], 'slot_uri': 'qudt:hasUnit'} })
    data_type: Optional[DataTypeEnum] = Field(default=None, description="""The data type category of this flow property.""", json_schema_extra = { "linkml_meta": {'domain_of': ['FlowProperty'], 'slot_uri': 'ont:dataType'} })
    iri: str = Field(default=..., description="""Globally unique IRI identifying this concept.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept']} })
    pref_label: str = Field(default=..., description="""Preferred human-readable label (English).""", json_schema_extra = { "linkml_meta": {'annotations': {'lang_tagged': {'tag': 'lang_tagged', 'value': True}},
         'domain_of': ['Concept'],
         'slot_uri': 'skos:prefLabel'} })
...
class FlowPropertyCollection(ConfiguredBaseModel):
    """
    A scheme/group file holding many flow properties.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'layer': {'tag': 'layer', 'value': 'vocabulary'}},
         'from_schema': 'https://vocab.sentier.dev/schemas/flow-property',
         'tree_root': True})

    scheme: str = Field(default=..., description="""The ConceptScheme IRI these flow properties belong to.""", json_schema_extra = { "linkml_meta": {'annotations': {'internal': {'tag': 'internal', 'value': True}},
         'domain_of': ['FlowPropertyCollection']} })
    flow_properties: Optional[list[FlowProperty]] = Field(default=None, description="""The flow properties in this collection.""", json_schema_extra = { "linkml_meta": {'domain_of': ['FlowPropertyCollection']} })


# Model rebuild
# see https://pydantic-docs.helpmanual.io/usage/models/#rebuilding-a-model
Concept.model_rebuild()
FlowProperty.model_rebuild()
FlowPropertyCollection.model_rebuild()
